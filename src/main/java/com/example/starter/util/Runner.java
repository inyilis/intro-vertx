...
public class Runner {
  ...
  private static final String STARTER_DIR = "starter";
  private static final String STARTER_JAVA_DIR = STARTER_DIR + "/src/main/java/";

  public static void runClusteredExample(Class clazz) {
    runExample(STARTER_JAVA_DIR, clazz, new VertxOptions(), null, true);
  }

  public static void runExample(Class clazz) {
    runExample(STARTER_JAVA_DIR, clazz, new VertxOptions(), null, false);
  }

  public static void runExample(Class clazz, DeploymentOptions options) {
    runExample(STARTER_JAVA_DIR, clazz, new VertxOptions(), options, false);
  }
